            ...
            <div className="row row-eq-height">
              <main className="col-sm-12 col-md-12 col-lg-9 offset-lg-0 col-xl-7 doc-page ml-xl-5">
                ...
                <section className='mb-5'>
                  ...
                  <p>
                    Artificial intelligence, APIs, data, and metadata form an ecosystem which is the foundation of digital knowledge management and machine intelligence.</p>

                  <p>Postman Open Technologies is keen to stay at the forefront of these constantly evolving fields. We are actively exploring related topics to ensure the Postman Platform remains responsive to the dynamic needs of developers, researchers, enterprise customers, and the open data and AI communities.</p>

                  <p>A parallel can be drawn between the Data-Information-Knowledge-Wisdom (DIKW) pyramid, a model that represents the transition from raw data to valuable wisdom, and our ecosystem, illustrating the interplay between its four integral components:</p>
                  <img src={withPrefix("/images/wisdom-illustration.png")} alt="Wisdom chart. Illustration" className='mb-4'/>
                  <p>To support this vision, we work in close collaboration with both internal and external stakeholders to help advance knowledge and build tools in these areas. </p>

                  <p>Our R&D efforts translate into innovative platform features, contribution to open source projects, and participation in various events and initiatives surrounding standards and best practices.</p>
                ...
                <section className='mb-5'>
                 ...
                 <p>Managing data in effective and responsible ways is therefore essential. Data traditionally resides in files and databases, and there is an urgent need to elevate it to a 21st century commodity, by making it  discoverable and accessible over APIs, and complement it with metadata.</p>
                 <p>This can be achieved through the modernization of data infrastructures and services, collaborating with data custodians and users, and fostering the adoption of standards and best practices.</p>
                </section>
                <section className='mb-5'>
                  <h4>Metadata</h4>
                  <p>Metadata is the key that unlocks the meaning and potential of data. Without metadata, data can be an indecipherable jumble. Metadata makes data understandable and usable by both humans and AIs. It also plays a critical role when it comes to provenance, privacy, and transparency.</p>
                  <p>The metadata challenge is not new and is an issue that the data producers, researchers, and scientific communities have been tackling for decades. Several standards and best practices have emerged, with the <a href='https://www.go-fair.org/'  target="_blank"
                    rel="noopener noreferrer nofollow">FAIR initiative</a> and <a href='https://www.w3.org/TR/dwbp/'  target="_blank"
                    rel="noopener noreferrer nofollow">Data on the Web Best Practices</a> providing good entry points into the matter.</p>
                    <p>Many organizations struggle to adopt and implement these practices effectively due to various factors such as lack of awareness and resources, limited technology expertise, or complexity of the standards. There's a pressing need to pay more attention to this area, to strengthen data management and ensure the integrity, effectiveness, and transparency of data and AI.</p>
                </section>
                <section className='mb-5'>
