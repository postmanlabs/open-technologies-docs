...
const IndexPage = ({ data }) => {
  ...
  const formdata = {
    ...
    legal:
      "By clicking 'Become a partner' below, you agree to the processing of personal data you provide in accordance with Postman's Privacy Policy. Postman respects your privacy, and information collected on this site is for the sole purpose of matching you with appropriate studies.",
  }
  return (
    <Layout>
            ...
            <div className="row">
              <div className="col-sm-12 col-md-5 col-lg-6 align-self-center">
                ...
                <p className="subtitle">
                  Open Tech is Postman's central instance for Open
                  Source&mdash;using, contributing to, and creating Open Source
                  software, specifications, libraries, and other components that
                  the API industry relies on both today and tomorrow.
                </p>
                <Button
                  onClick={() => {
      ...
      <Divider fullWidth />
      <CallOut
        body={maincallout.body}
        divider="false"
        paddingBottomStyles="0px"
      />
            ...
            <div className="row">
              <div className="col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-0 mb-5 mb-lg-0 ">
                ...
                <div className="text-center">
                  <img
                    alt="Postmanaut on hoverboard. Illustration."
                    className="img-fluid"
                    src="https://voyager.postman.com/illustration/get-in-touch-postman-hoverboard-illustration.svg"
                  />
                </div>
              </div>
