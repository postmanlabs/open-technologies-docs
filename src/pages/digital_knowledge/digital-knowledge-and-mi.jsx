            ...
            <div className="row row-eq-height">
              <main className="col-sm-12 col-md-12 col-lg-9 offset-lg-0 col-xl-7 doc-page ml-xl-5">
                ...
                <section className='mb-5'>
                  ...
                  <p>Postman Open Technologies is keen to stay at the forefront of these constantly evolving fields. We are actively exploring related topics to ensure the Postman API Platform remains responsive to the dynamic needs of developers, researchers, and the open data and AIcommunities.</p>
