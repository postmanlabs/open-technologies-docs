    ...
    for (let index = 0; index < leftNavItems.length; index++) {
      ...
      leftNavItems[index].subMenuItems1.map((subMenuItem1, index2) => {
        ...
        subMenuItem1.subMenuItems2 &&
          subMenuItem1.subMenuItems2.map((subMenuItem2) => {
      ...
      <BreadCrumbStyles className=" mb-3" aria-label="breadcrumbs">
        <ol className="lc-breadcrumbs">
          <li>
            <Link
              to="/"
              className="small breadcrumb-home-link"
              title="Open Tech"
            >
              Home
            </Link>
          ...
          {JSON.stringify(subParentLink) !== "{}" ? (
            <>
              <li>
                <Link
                  to={parentLink.url}
                  className="small breadcrumb-parent-link"
                >
                  {parentLink.name}
                </Link>
                <span className="small" aria-hidden="true">
              ...
              <li>
                <Link
                  to={subParentLink.slug}
                  className="small breadcrumb-subparent-link"
                >
                  {subParentLink.name}
                </Link>
              </li>
...
function BreadCrumbsLinks() {
  ...
  return <BreadCrumbsLinksComponent pathPrefix={data.site.pathPrefix} />
}
